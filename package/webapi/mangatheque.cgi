...
REQUEST_PARAMETER = { 
    ...
    "personnes": { "table": "Personnes", "columns": [{ "name":"id", "type": "int"}, { "name":"name", "type": "string" }, { "name":"firstname", "type": "string" }, { "name":"sexe", "type": "char" }, { "name":"naissance", "type": "string" }, { "name":"cover", "type": "string" }] },
    ...
    "tomes": { "table": "Tomes", "columns": [{ "name":"code", "type": "string" }, { "name":"name", "type": "string" }, { "name":"date_VF", "type": "string" }, { "name":"date_VO", "type": "string" }, { "name":"volumes", "type": "float" }, { "name":"pages", "type": "int" }, { "name":"resumer", "type": "string" }, { "name":"cover", "type": "string" }, { "name":"GenreId", "type": "int" }, { "name":"SeriesId", "type": "int" }] }
}
